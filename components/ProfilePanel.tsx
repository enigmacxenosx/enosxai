 ...
 * Sign in / Sign up with Google or email, profile editing,
              ...
              {view === 'auth' && (
                <div className="px-5 py-6 space-y-5">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 py-3 rounded-2xl font-semibold text-sm transition-all hover:scale-[1.02] active:scale-[0.98]"
                    style={{ background: 'rgba(255,255,255,0.07)', border: '1px solid rgba(255,255,255,0.12)', color: 'rgba(255,255,255,0.9)', boxShadow: '0 2px 12px rgba(0,0,0,0.3)' }}
                  >
