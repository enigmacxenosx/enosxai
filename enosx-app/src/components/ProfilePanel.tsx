              ...
              {view === 'auth' && (
                <div className="px-5 py-6 space-y-5">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 py-3.5 rounded-2xl font-bold text-sm transition-all hover:scale-[1.02] active:scale-[0.98] rainbow-glow shadow-xl"
                    style={{ 
